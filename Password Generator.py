...
Title = Label(root, text="Password Generator", bg="beige", fg="Red", font=("futura", 18, "bold"))
Title.pack(anchor="center", pady="20px")

length = Label(root, text="Select the Length of Your Password :- ", fg="blue", bg="beige", font=("ubuntu", 12))
...
result_lable = Label(root, text="Generated Password Here :- ", bg="beige", fg="blue", font=("ubuntu", 12))
